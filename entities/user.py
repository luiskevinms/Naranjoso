...
class User:
    ...
    def insert(name, curp, account, password):
        ...
        sql = "INSERT INTO users (name, curp, account, password) VALUES (%s, %s, %s, %s)"
    ...
    def check_account_exists(account):
        ...
        #Retornar true si la colección contiene 1 o más elementos. Si contiene cero elementos, retornar false
        connection = get_connection()
